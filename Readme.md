...
## Описание и запуск SERVER в среде Docker
...
Проект будет доступен из браузера по ссылке `http://localhost:8080/`.

Настройки сервера в файле `application.yml` директории `resources`.
